...
const Payment = () => {
  ...
  return (
   <div className='bg-white p-7 lg:p-20 gap-8 lg:gap-10'>
    <div className='flex items-center md:flex-row flex-col md:justify-center '>
      <div className='md:w-1/2'><h2 className='md:text-center text-[40px] md:text-[70px] font-extrabold text-[#004E89] '>Effortless Events</h2></div>
      <div className='md:w-1/2'><h6 className='font-medium text-xl '>Book College Events empowers organizers to  <br />create stunning college events with just a few <br /> clicks. Focus on making your events amazing while <br /> we handle the tedious booking process.</h6></div>
    </div>

    <div className='grid grid-cols-1 lg:grid-cols-3 lg:gap-10 mt-44'>
        <div>
          <img className='rounded-3xl' src="https://framerusercontent.com/images/LwEZyNMIoQY9PRxG85u3fhKm8.jpg" alt="" />
          <h2 className='text-[#004E89] font-semibold text-xl mt-6'>Student Meetups</h2>
          <h3 className='text-[#004E89] font-semibold text-xl mt-2'>Engage with peers and discover new opportunities at campus clubs and gatherings.</h3>
        </div>
        <div>
          <img className='rounded-3xl' src="https://framerusercontent.com/images/LwEZyNMIoQY9PRxG85u3fhKm8.jpg" alt="" />
          <h2 className='text-[#004E89] font-semibold text-xl mt-6'>Student Meetups</h2>
