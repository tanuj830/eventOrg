...
<div className=' mt-20 sm:mt-24 md:mt-30 lg:mt-0 px-5 lg:w-[50vw] flex items-center justify-end'>
    <div className=''>
...
<p className='inline-block lg:hidden text-md mt-10 xl:mt-10 font-medium'>Welcome to Book College Events, your one-stop-shop for affordable and accessible event organizing and booking. Say  goodbye to traditional difficulties and hello to seamless payment  gateways and magnificent event management.
